...
export default function Navbar() {
    ...
    return (
        <header className='fixed w-full top-0 z-50 bg-black shadow-[0px_4px_5px_rgb(62,62,62)]'>
        ...
        <nav className='hidden md:flex flex-col items-center p-4'>
            ...
            <Link
                href="/"
                className="h-24 overflow-hidden flex items-center justify-center relative z-10"
                >
                <img
